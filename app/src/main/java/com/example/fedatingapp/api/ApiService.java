...
public interface ApiService {
    ...
    Call<ApiResponse<Void>> requestPasswordResetOtp(@Query("identifier") String identifier);
    ...
    Call<ApiResponse<ResetPasswordRequest>> resetPassword(@Body ResetPasswordRequest requestDto);
